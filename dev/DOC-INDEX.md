...
| `dev/plans/plan-0.8.25.md` | Active dependency-linear performance and Memex data-plane foldback plan | 0.8.25 | 2026-08-31 |
| `dev/plans/memex-0.6.0-needs-in-fathomdb-0.8.25.md` | Code-grounded Memex needs crosswalk and slice allocation | 0.8.25 Slice 5 | 2026-08-31 |
| `dev/plans/fathomdb-data-plane-foldback-v2.md` | Draft dependency-linear requirements/design/TDD delivery plan | 0.8.25 Slice 5 | 2026-08-31 |
...
| `dev/design/fathomdb-data-plane-architecture-v2.md` | Draft data-plane architecture for full performance and Memex foldback | 0.8.25 Slice 5 | 2026-08-31 |
