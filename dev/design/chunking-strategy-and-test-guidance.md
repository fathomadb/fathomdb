...
|---|---|---|
| Microsoft GraphRAG | Yes. It creates configurable TextUnits; the native defaults are 1,200 tokens with 100-token overlap, and uses them for LLM entity/relationship extraction and provenance. Our planned native comparison pins that geometry. [GraphRAG configuration](https://microsoft.github.io/graphrag/config/yaml/), [our comparison plan](../performance-benchmarking/plans/2026-08-11-graphrag-baseline-readiness.md) | Different objective: extraction-quality and graph construction, not solely dense passage retrieval fused with document BM25. |
