...
HITL `seq-268` approves this `stream_default` production landing and supersedes
the earlier `rank_default` production-path decision at `seq-265`.
...
- authorization: `seq-267`
- production selection: `seq-268`
