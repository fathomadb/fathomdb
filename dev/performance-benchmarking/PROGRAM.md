...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V2 paid execution authorized at a $12 hard cap. The authorized zero-spend preflight passed; run fresh A/A and the three-question witness, then held-out only if the witness is valid. | [track plan](tracks/global-01-native-graphrag.md) · [recovery contract](2026-08-29-global-01-v2-recovery-contract.md) · [preflight](2026-08-29-global-01-v2-preflight-result.md) · [receipt](../../experiments/runs/global-01-lazy-preflight-20260829T2045Z-483e11ad/record.json) |
...
registered with a corrected output adapter and passing zero-spend preflight;
paid execution is authorized at a $12 hard cap. Run fresh A/A and the
three-question witness, then held-out only if the witness is valid. REASON-01
retains its independent native-run prerequisites.
