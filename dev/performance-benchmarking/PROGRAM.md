...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V4 keeps the 4,096-token matched ceiling and uses short local reduction references with deterministic canonical restoration. The adapter and fail-closed validator are test-backed; run zero-spend preflight next. | [track plan](tracks/global-01-native-graphrag.md) · [output-limit basis](2026-08-29-global-01-output-limit-research.md) · [v3 receipt](../../experiments/runs/global-01-lazy-witness-20260829T2118Z-b0f3c328/record.json) |
