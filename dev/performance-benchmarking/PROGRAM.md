...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V5 resolved scorer truncation but exact-shape validation rejected harmless explanatory keys. Register a deterministic projection of the two required scorer fields in v6, preflight, then run fresh A/A and witness. | [track plan](tracks/global-01-native-graphrag.md) · [output-limit basis](2026-08-29-global-01-output-limit-research.md) · [v5 witness](../../experiments/runs/global-01-lazy-witness-20260829T2144Z-da326e0b/record.json) |
