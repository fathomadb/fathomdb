...
| SCALE-02 | P3 | F-17 advisory scale envelope: what measured local-first range is supportable for the selected projection profile? | `rank_default` approved and landed with exact 132-query equivalence; approved formal 10k rerun is next. | [track plan](tracks/scale-02-local-first-envelope.md) · [result](2026-08-22-scale-02-fts-followup-result.md) · [approved config](../../experiments/configs/scale-02/a0-envelope.v2.json) |
...
landing. The formal 10k rerun is next.
