...
| SCALE-02 | follow-up complete | F-17 advisory scale envelope: what measured local-first range is supportable for the selected projection profile? | The original fixed-policy A0 envelope remains 17,272. The authorized rank-boundary off-shoot passes through 50k with exact retrieval equivalence and recommends streamed boundary-tie completion with shipped reader defaults; production landing awaits HITL decision. | [track plan](tracks/scale-02-local-first-envelope.md) · [original result](2026-08-22-scale-02-fts-followup-result.md) · [scale extension](2026-08-22-scale-02-scale-extension-result.md) · [rank-boundary result](2026-08-22-scale-02-rank-boundary-result.md) |
...
for mmap128. Production landing awaits the post-result HITL decision.
