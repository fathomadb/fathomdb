...
| LOCOMO-01 | P1 | LOCOMO self-characterization: which FathomDB retrieval configuration is eligible for answer scoring? | Active; Phase-A plan-only provenance and grid preparation is integrated. Fixed-subset and full-grid execution remain separately authorized; report factoid, temporal, and multi-session results separately. | [track plan](tracks/locomo-01-self-characterization.md) |
...
| SCALE-01 | P1 | TC-5 eu7 scale fidelity: what manifest-qualified all-real CPU fidelity envelope is observed? | Planned; manifest and test-only plan-only runner preparation is integrated. Smoke and characterization execution remain separately authorized and may proceed independently of LOCOMO work. | [track plan](tracks/scale-01-tc5-fidelity.md) |
