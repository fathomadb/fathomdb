...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | The documented model limit is 393,216 output tokens; the registered 1,500-token reduction ceiling caused deterministic truncation. V3 uses a bounded 4,096-token reduction ceiling, preserves the comparison, and is ready for zero-spend preflight. | [track plan](tracks/global-01-native-graphrag.md) · [output-limit basis](2026-08-29-global-01-output-limit-research.md) · [v2 execution note](2026-08-29-global-01-v2-witness-execution-note.md) |
