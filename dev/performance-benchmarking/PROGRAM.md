...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V2 A/A passed, but the witness exposed a deterministic semantic-retry defect and stopped before held-out work. Validation-aware retries are implemented; repeat zero-spend preflight, then use a fresh witness root. | [track plan](tracks/global-01-native-graphrag.md) · [recovery contract](2026-08-29-global-01-v2-recovery-contract.md) · [execution note](2026-08-29-global-01-v2-witness-execution-note.md) · [receipt](../../experiments/runs/global-01-lazy-witness-20260829T2047Z-483e11ad/record.json) |
...
GLOBAL-01 v1 stopped at an invalid development witness after A/A passed. V2 is
registered with a corrected output adapter. Its first fresh witness also
stopped before held-out work because deterministic semantic retries omitted
validation feedback. The runner correction preserves the contract; repeat the
zero-spend preflight and use a fresh witness root. REASON-01 retains its
