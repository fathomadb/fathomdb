...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V2 recovery ready for HITL. The v1 witness remains invalid; the corrected attribution adapter and fresh zero-spend preflight are complete. New paid-run authorization is required. | [track plan](tracks/global-01-native-graphrag.md) · [recovery contract](2026-08-29-global-01-v2-recovery-contract.md) · [preflight](2026-08-29-global-01-v2-preflight-result.md) · [receipt](../../experiments/runs/global-01-lazy-preflight-20260829T2026Z-15096cae/record.json) |
...
paid execution awaits new HITL authorization and a hard cap. REASON-01 retains
