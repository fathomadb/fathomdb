...
| GLOBAL-01 | P3 | Global sensemaking: can a bounded source-linked coverage treatment close the first run's coverage gap without losing directness, attribution, lifecycle fidelity, or acceptable cost? | V6 validated scorer projection and completed one question's evaluation, then exhausted generic map corrections on uncited/overlong output. Bind targeted content-free correction instructions in v7 and run one fresh witness. | [track plan](tracks/global-01-native-graphrag.md) · [output-limit basis](2026-08-29-global-01-output-limit-research.md) · [v6 witness](../../experiments/runs/global-01-lazy-witness-20260829T2151Z-52b3aafe/record.json) |
