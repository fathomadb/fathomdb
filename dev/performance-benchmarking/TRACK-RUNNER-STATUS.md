...
1. Repeat GLOBAL-01 v2 zero-spend preflight after output-limit classification.
2. Resume the bound witness checkpoint; retain completed A/A and map cells.
...
| [GLOBAL-01](tracks/global-01-native-graphrag.md) | Output-limit correction ready for preflight | Map validation recovered, but the [next witness](../../experiments/runs/global-01-lazy-witness-20260829T2054Z-483e11ad/record.json) exhausted three reductions at exactly 1,500 tokens. Bind the content-free output-limit correction, then resume. |
