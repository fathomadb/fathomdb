...
1. Run fresh GLOBAL-01 v2 A/A and the three-question witness.
...
| [GLOBAL-01](tracks/global-01-native-graphrag.md) | V2 corrected and authorized | The [fresh preflight](../../experiments/runs/global-01-lazy-preflight-20260829T2053Z-483e11ad/record.json) passed at $0 after the content-free retry correction; run A/A and the witness from a new root. |
