...
| [SCALE-02](tracks/scale-02-local-first-envelope.md) | Follow-up designed | Preserve the [scale-extension result](2026-08-22-scale-02-scale-extension-result.md). The [rank-boundary off-shoot](2026-08-22-scale-02-rank-boundary-design.md) awaits HITL implementation and execution authorization. |
