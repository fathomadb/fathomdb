...
1. **SCALE-02:** complete the registered compact tuning and equivalence run,
   then synthesize the pending-HITL formal configuration.
...
| [SCALE-02](tracks/scale-02-local-first-envelope.md) | Follow-up running | Complete tuning/equivalence and configuration synthesis; do not run formal 10k. |
