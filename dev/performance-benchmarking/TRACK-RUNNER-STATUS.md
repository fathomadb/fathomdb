...
| [CORPUS-01](tracks/corpus-01-gold-coverage.md) | Complete, limited | Preserve `seq-269` and the [result](2026-08-23-corpus-01-supersession-human-review-result.md); neither reviewed case qualifies as supersession gold. |
