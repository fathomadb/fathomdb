...
1. Run fresh v3 A/A and the three-question witness from a new root.
...
| [GLOBAL-01](tracks/global-01-native-graphrag.md) | V3 authorized and preflighted | The [post-fix preflight](../../experiments/runs/global-01-lazy-preflight-20260829T2117Z-b0f3c328/record.json) passed at $0; run a fresh A/A and witness root. |
