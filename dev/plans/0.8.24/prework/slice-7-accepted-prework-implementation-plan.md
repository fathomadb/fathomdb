...
Implement only the bounded prework maintenance accepted in Slice 6, with one
writer, explicit file scope, proportional verification, and durable evidence.
Feature implementation remains in Slices 10–70.
