...
Before work, enumerate changes since this draft, the recorded D26-04 and D26-05
rulings (`seq-284`, `seq-285`), current actuation/schema code, allocated Slice
3–5 items, and completed
...
2. Commit or stage visible RED tests for the current V1 digest, atomic graph unit,
   rollback, replay, concurrency, endpoint and lifecycle ordering, receipt
   integrity, erasure, projection, absence of V2 surfaces/routing, and
   old-database refusal.
