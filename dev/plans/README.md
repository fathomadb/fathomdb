...
| 0.8.24 | feature planning and implementation | Prework and Slices 10/20 are complete; Slice 30 is blocked on its first-party index endpoint/publisher route; no live release-state record exists. |
