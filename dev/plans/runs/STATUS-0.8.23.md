...
| 10 | CUDA-CONTRACT — CUDA environment, artifact contract, and protected runner gate | IN PROGRESS — local controls include the reviewed dry-run provenance correction through `4ff8d146`; candidate `623bbba6` has a retained, verifier-passing pinned RTX 3090 witness. Main control-plane/provenance integration and GitHub dry-run evidence remain required. |
