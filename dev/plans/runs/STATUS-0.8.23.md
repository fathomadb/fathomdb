...
| 10 | CUDA-CONTRACT — CUDA environment, artifact contract, and protected runner gate | IN_PROGRESS — audited static contract; secure protected-route decision and trusted hardware witness remain open. |
