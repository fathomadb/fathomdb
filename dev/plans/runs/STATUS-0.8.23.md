...
<!-- BEGIN GENERATED release-state:0.8.23:status-current-state -->**Next is Slice 20 (CUDA-PACKAGE), NOT_STARTED.** Completed on `origin/release/0.8.23`; `origin/main` integration is PENDING: 0 (`916023fe`) · 1 (`2167a0cd`) · 2 (`b363af85`) · 3 (`91e162c2`) · 4 (`a7df1590`) · 5 (`00f865f3`) · 6 (`e98f727d`) · 30 (`776d2c20`) · 50 (`ae7cef0e`) · 60 (`423baf6a`) · 65 (`6b57557c`) — verified reachable, not asserted.<!-- END GENERATED release-state:0.8.23:status-current-state -->
...
| | |
| --- | --- |
| **Immediate next action** | <!-- BEGIN GENERATED release-state:0.8.23:status-next-action -->**Commission Slice 20 (CUDA-PACKAGE)** — CUDA package, rehearsal, and installed-artifact smokes. **Remaining ladder:** 20 → 70 → 40.<!-- END GENERATED release-state:0.8.23:status-next-action --> |
...
publication only. Local Slice 20 and then Slice 70 work may proceed under their
own gates (HITL `seq:249`). Slice 40 is set aside; its V2 runner work remains
