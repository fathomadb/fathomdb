...
require_text "dev/performance-benchmarking/TRACK-RUNNER-STATUS.md" "## Current lanes"
require_text "dev/performance-benchmarking/TRACK-RUNNER-STATUS.md" "## Track status"
require_text "dev/performance-benchmarking/TRACK-RUNNER-STATUS.md" "## Update protocol"
