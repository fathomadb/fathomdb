...
require "$SLICE70" '`["/tmp/fathomdb-cli/fathomdb-${version}-x86_64-unknown-linux-gnu/fathomdb", "doctor", "gpu", "--json"]`'
...
require "$SLICE20" '`["/tmp/fathomdb-cli/fathomdb-${version}-x86_64-unknown-linux-gnu/fathomdb", "doctor", "gpu", "--json"]`'
