...
require dev/design/0.8.23-slice-20-cuda-package-rehearsal.md 'compatible-GPU CLI evidence stays `PENDING_EXTERNAL`'
require dev/design/0.8.23-slice-20-cuda-package-rehearsal.md '`cuda:0` unavailable smoke'
...
require dev/design/0.8.23-slice-70-dual-runtime-device-policy.md 'only driverless CPU with policy unset/`auto`'
