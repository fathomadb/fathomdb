...
assert_job_contains tegra-cuda-evidence '--expected-version 0.8.24' "Jetson build is hard-bound to the authorized base version"
assert_job_contains prepare-tegra-pages '--expected-version 0.8.24' "Pages publisher is hard-bound to the authorized base version"
