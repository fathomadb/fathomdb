...
assert_contains '      candidate_version:' "Pages route receives an explicit candidate version"
...
assert_job_contains prepare-tegra-pages "startsWith(github.ref, 'refs/heads/release/')" "Pages preparation is bounded to a release branch"
assert_job_contains deploy-tegra-pages "startsWith(github.ref, 'refs/heads/release/')" "Pages deployment is bounded to a release branch"
