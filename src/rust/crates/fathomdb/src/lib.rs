...
pub use fathomdb_engine::{
    ...
    SoftFallback, SoftFallbackBranch, SourceDependencyRegistrationV1, SourceDependencyV1, SourceId,
    SourceLocator, SourceRevisionId, SourceVersionId, Subscription, TraversalDirection,
    WriteProvenanceV1, WriteReceipt,
};
