...
pub use fathomdb_engine::{
    ...
    CorruptionKind, CorruptionLocator, CounterSnapshot, DataPlaneIntegrityRequestV1,
...
pub use fathomdb_engine::{
    ...
    DataPlaneIntegrityFindingCodeV1, DataPlaneIntegrityFindingV1, DataPlaneIntegrityResultV1,
