...
pub use fathomdb_engine::{
    ...
    EngineError, EngineOpenError, ExciseReport, Explanation, ExtractDocument, FrozenReadContextV1,
    ...
    MutationProjectionStatusV1, NodeRecord, OpenReport, OpenStage, OpenedEngine, PerHitExplain,
    Predicate, PreparedWrite, ProjectionDelta, ProjectionFts, ProjectionGenerationError,
    ProjectionGenerationErrorReason, ProjectionGenerationId, ProjectionGenerationOriginV1,
    ProjectionGenerationStatusV1, ProjectionReadinessV1, ProjectionRole, ProjectionRuntimeStateV1,
    ...
    ReadContextV1, ReadView, RecoveryHint, ScalarValue, SearchExpandResult, SearchFilter,
    SearchResult, SoftFallback, SoftFallbackBranch, SourceDependencyRegistrationV1,
    SourceDependencyV1, SourceId, SourceLocator, SourceRevisionId, SourceVersionId, Subscription,
