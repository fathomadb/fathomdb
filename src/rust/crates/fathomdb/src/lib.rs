...
pub use fathomdb_engine::{
    encode_resolved_graph_evidence_v1, ActuationBatchV1, ActuationError, ActuationErrorReason,
    ActuationOperationV1, ActuationOutcomeV1, ActuationReceiptV1, ActuationRefusalReasonV1,
    ArtifactRevisionId, BoundaryCrossing, CanonicalHash, ClosureCauseV1, ClosureLookupV1,
    ClosureOperationId, ClosurePhaseV1, ClosureProofV1, ClosureRootV1, ClosureStatusV1,
    ComparisonOp, CorruptionDetail, CorruptionKind, CorruptionLocator, CounterSnapshot,
    ...
    EmbeddingReadiness, EmbeddingReadinessState, Engine, EngineError, EngineOpenError,
    ...
    EvidenceSidecarEntryV1, ExciseReport, Explanation, ExtractDocument, FrozenReadContextV1,
    FrozenReadError, FrozenReadErrorReason, GraphEvidenceArtifactV1, GraphEvidenceRefV1,
    GraphEvidenceResolveRequestV1, GraphEvidenceSidecarEntryV1, GraphEvidenceSidecarV1,
    ...
    GraphSeedSourceV1, GraphSeedV1, GraphTargetExplanationV1, GraphTargetV1,
    IngestWithExtractorReceipt, InitialState, LifecycleActuationV1, LifecycleState,
    MutationProjectionStatusRequestV1, MutationProjectionStatusV1, NodeRecord, OpenReport,
    OpenStage, OpenedEngine, OperationalStateRecordV1, PageCursor, PageError, PageErrorReason,
...
pub use fathomdb_engine::{
    CheckIntegrityOpts, DataPlaneIntegrityBoundaryV1, DataPlaneIntegrityCheckCountV1,
    DataPlaneIntegrityCheckV1, DataPlaneIntegrityErrorReasonV1, DataPlaneIntegrityErrorV1,
    DataPlaneIntegrityFindingCodeV1, DataPlaneIntegrityFindingV1, DataPlaneIntegrityRequestV1,
    DataPlaneIntegrityResultV1, DataPlaneIntegritySeverityV1, DumpProfileReport,
    DumpRowCountsReport, DumpSchemaReport, ExciseRecordReport, Finding, IntegrityReport,
    MeanRecomputeReport, OrphanProvenanceReport, OrphanProvenanceSource, RebuildKind,
